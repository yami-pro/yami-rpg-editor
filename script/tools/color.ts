...
Color.initialize = function () {
  ...
  document.querySelectorAll('[name="color-index"]').on('pointerdown', this.indexedColorPointerdown)
  document.querySelectorAll('#color-r, #color-g, #color-b, #color-a').on('input', this.rgbaInput)
