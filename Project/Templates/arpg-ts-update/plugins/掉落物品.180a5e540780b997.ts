...
#desc
Добавить в сцену выпадение предметов или снаряжения
Задайте атрибут качества предмета (тип строковый)
Анимация автоматически переключится на движение, в имени которого указано значение атрибута качества.
...
Локальная Переменная: type = "item"
...
#qualityKey Атрибут Качество 
#motionKey Особая Анимация Движения
#defQuality Кач-во по умолчанию
#iconLayer Имя Слоя Иконки
...
#attractionDistance Расстояние притяжения
