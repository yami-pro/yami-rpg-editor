...
#weakMagnitude-desc  Интенсивность низкочастотных вибрации моторов (слабая), нормализованная в диапазоне от 0.0 до 1.0
#strongMagnitude Сильная амплитуда 
#strongMagnitude-desc Интенсивность низкочастотных вибрации моторов (сильная), нормализованная в диапазоне от 0.0 до 1.0
