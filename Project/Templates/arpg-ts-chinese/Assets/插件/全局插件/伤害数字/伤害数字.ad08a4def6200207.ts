...
PluginManager.DamageNumber.popup(цель, стиль, значение)
Цель: Объект с координатами сцены
Стиль: Значение 0-5 соответствует рисунку спрайта 0-5
Значение: Величина урона, которая отображается в целевом местоположении
#startXMean Старт X
...
#translationXDev Перемещ X
#translationXDev-desc Максимальное произвольное расстояние перемещения по горизонтали
#translationYDev Перемещ Y
#translationYDev-desc Максимальное произвольное расстояние перемещения по вертикали
#startScale Старт Размер.
#startScale-desc Размер показателя урона на старте
#endScale Конец Размер.
#endScale-desc Размер показателя урона в конце
#startOpacity Старт Прозрачность
#startOpacity-desc Прозрачность показателя урона на старте
#endOpacity Конец Прозрачность
#endOpacity-desc Прозрачность показателя урона в конце
#xEasingId Плавность X
#xEasingId-desc Горизонтальное перемещение - изменение количества повреждений
#yEasingId Плавность Y
#yEasingId-desc Вертикальное перемещение - изменение количества повреждений
#scaleEasingId Плавность Размер
#scaleEasingId-desc Изменение масштаба количества повреждений
#opacityEasingId Плавность Прозрачность
#opacityEasingId-desc Переход чисел повреждений в Прозрачность
#duration Продолж-сть (мс)
#duration-desc Время, необходимое для появления и исчезновения числа.
#numberImage0 Изображение 0
#numberImage0-desc Используется для отображения урона в стиле [0]
#numberImage1 Изображение 1
#numberImage1-desc Используется для отображения урона в стиле [1]
#numberImage2 Изображение 2
#numberImage2-desc Используется для отображения урона в стиле [2]
#numberImage3 Изображение 3
#numberImage3-desc Используется для отображения урона в стиле [3]
#numberImage4 Изображение 4
#numberImage4-desc Используется для отображения урона в стиле [4]
#numberImage5 Изображение 5
#numberImage5-desc Используется для отображения урона в стиле [5]
